<template>
  <div class="user-center-wrapper clear-fix">
    <el-card shadow="always" :body-style="{padding: '50px'}">
      ...
      <el-button style="margin:0px 120px" type="primary" @click="basicFormVisible= true">基本信息修改</el-button>
      <ul class="user-info">
                <li>
          <label>密码：</label>
          ...
          <el-form :model="form" :rules="rules">
            ...
            <el-form-item label="生日" :label-width="formLabelWidth" >
              <el-input v-model="userInfo.birthday" autocomplete="off" disabled></el-input>
            </el-form-item>
